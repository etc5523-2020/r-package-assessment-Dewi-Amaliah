                                 ...
                                 column(width = 8,
                                        ...
                                        p("This app built with",
                                          icon("r-project",
                                               lib = "font-awesome"),
                                          ", mainly with", 
                                          getlink("https://shiny.rstudio.com", "shiny"),
                                          "with the help of several other packages: ",
                                          getlink("https://www.tidyverse.org", "tidyverse,"),
                                          getlink("https://rstudio.github.io/shinythemes/", "shinythemes,"),
                                          getlink("https://CRAN.R-project.org/package=shinyWidgets", "shinyWidgets,"),
                                          getlink("https://plotly-r.com", "plotly,"),
                                          getlink("https://CRAN.R-project.org/package=readxl", "readxl,"),
                                          getlink("http://www.jstatsoft.org/v40/i03/", "lubridate,"),
                                          getlink("https://CRAN.R-project.org/package=maps", "maps,"),
                                          getlink("https://CRAN.R-project.org/package=viridis", "viridis,"),
                                          getlink("https://CRAN.R-project.org/package=viridisLite", "viridisLite,"),
                                          getlink("https://CRAN.R-project.org/package=mapproj", "mapproj,"),
                                          getlink("https://CRAN.R-project.org/package=DT", "DT,"),
                                          getlink("https://CRAN.R-project.org/package=here", "here,"),
                                          "and",
