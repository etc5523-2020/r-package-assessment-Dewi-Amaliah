                      ...
                      tabPanel("References",
                               ...
                               fluidRow(
                                 ...
                                 column(width = 9,
                                        ...
                                        tags$li(class= "li-custom", "European Centre for Disease Control and Prevention, dowloaded with",
                                                tags$a(href = "https://github.com/joachim-gassen/tidycovid19",
                                                       "tidycovid-19 R Package",
                                                       class = "externallink"),
                                                ", 2020",
                                        ...
                                        tags$li(class= "li-custom", "Google Community Mobility Report, downloaded with",
                                                tags$a(href = "https://github.com/joachim-gassen/tidycovid19",
                                                       "tidycovid19 R Package",
                                                       class = "externallink"),
                                                ", 2020",
                                                "- Community Mobility Index during Pandemic"),
                                        tags$li(class= "li-custom", 
                                                tags$a(href = "https://worldmap.harvard.edu/data/geonode:country_centroids_az8",
                                                       "Harvard WorldMap",
                                                       class = "externallink"),
                                                ", 2020",
                                 ...
                                 column(width = 8,
                                        br(),
                                        #br(),
                                        tags$li(class = "li-custom", "David Druvolo, 2019 -",
                                                tags$a(href = "hhttps://davidruvolo51.github.io/shinytutorials/tutorials/landing-page/",
                                                       "Custom home pages in shiny",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "European Centre for Disease Control and Prevention, 2020 -",
                                                tags$a(href = "https://www.ecdc.europa.eu/sites/default/files/documents/2020-08-12_Variable_Dictionary_and_Disclaimer_weekly_testing_data_EUEEAUK_0.pdf",
                                                       "Data dictionary on COVID-19 testing",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "European Centre for Disease Control and Prevention, 2020 -",
                                                tags$a(href = "https://www.ecdc.europa.eu/sites/default/files/documents/Variable_Dictionary_and_Disclaimer.pdf",
                                                       "Data dictionary of response measures",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "European Centre for Disease Control and Prevention, 2020 -",
                                                tags$a(href = "https://www.ecdc.europa.eu/sites/default/files/documents/Variable_Dictionary_and_Disclaimer.pdf",
                                                       "Data dictionary of response measures",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Our World in Data, 2020 -",
                                                tags$a(href = "https://ourworldindata.org/covid-mobility-trends",
                                                       "Google Mobility Trends: How has the pandemic movement of people around the world?",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Scott Gottlieb in Jennifer Kates, et.al., 2020 -",
                                                tags$a(href = "https://www.kff.org/policy-watch/what-testing-capacity-do-we-need/",
                                                       "What Testing Capacity Do We Need?",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "World Health Organization in Pien Huang, 2020 -",
                                                tags$a(href = "https://www.npr.org/sections/coronavirus-live-updates/2020/03/30/824127807/if-most-of-your-coronavirus-tests-come-back-positive-youre-not-testing-enough",
                                                       "If Most Of Your Coronavirus Tests Come Back Positive, You're Not Testing Enough",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "World Health Organization in Our World in Data, 2020 -",
                                                tags$a(href = "https://ourworldindata.org/coronavirus-testing",
                                 ...
                                 column(width = 8,
                                        br(),
                                        #br(),
                                        tags$li(class = "li-custom", "Carson Sievert, 2020 -",
                                                tags$a(href = "https://plotly-r.com",
                                                       "Interactive Web-Based Data Visualization with R, plotly, and shiny",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Garrett Grolemund and Hadley Wickham, 2011 -",
                                                tags$a(href = "http://www.jstatsoft.org/v40/i03/",
                                                       "Dates and Times Made Easy with {lubridate}",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Hadley Wickham, 2016 -",
                                                tags$a(href = "https://ggplot2.tidyverse.org",
                                                       "ggplot2: Elegant Graphics for Data Analysis",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Hadley Wickham and Jennifer Bryan, 2019 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=readxl",
                                                       "readxl: Read Excel Files",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Hadley Wickham, et.al., 2019 -",
                                                tags$a(href = "https://www.tidyverse.org",
                                                       "Welcome to the {tidyverse}",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Joachim Gassen, 2020 -",
                                                tags$a(href = "https://github.com/joachim-gassen/tidycovid19",
                                                       "tidycovid19: Download, Tidy and Visualize Covid-19 Related Data",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Kirill Müller -",
                                                tags$a(href = "https://CRAN.R-project.org/package=here",
                                                       "here: A Simpler Way to Find Your Files",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Ray Brownrigg and Thomas P Minka, 2020-",
                                                tags$a(href = "https://CRAN.R-project.org/package=mapproj",
                                                       "mapproj: Map Projections",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Ray Brownrigg, enhanced by Thomas P Minka and Alex Deckmyn, 2018-",
                                                tags$a(href = "https://CRAN.R-project.org/package=maps",
                                                       "maps: Draw Geographical Maps",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Simon Garnier, 2018 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=viridis",
                                        ...
                                        tags$li(class = "li-custom", "Simon Garnier, 2018 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=viridisLite",
                                                       ...
                                                       class = "externallink")),
                                        tags$li(class= "li-custom", "Winston Chang, Joe Cheng, JJ Allaire, Yihui Xie, and Jonathan McPherson, 2020 -",
                                                tags$a(href = "https://shiny.rstudio.com",
                                        ...
                                        tags$li(class = "li-custom", "Winston Chang, 2018 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=shinythemes",
                                                       ...
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Victor Perrier, Fanny Meyer, David Granjon, 2020 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=shinythemes",
                                                       "shinyWidgets: Custom Inputs Widgets for Shiny",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Yihui Xie, Joe Cheng, and Xianying Tan, 2020 -",
                                                tags$a(href = "https://CRAN.R-project.org/package=DT",
                                 ...
                                 column(width = 8,
                                        br(),
                                        tags$li(class = "li-custom", "freepik, 2020 -",
                                                tags$a(href = "https://www.flaticon.com/free-icon/dashboard_2303502?term=dashboard&page=1&position=86",
                                                       "Dashboard",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "Julian Wan, 2020 -",
                                                tags$a(href = "https://unsplash.com/photos/DWaC44FUV5o",
                                                       "A couple enjoying sunshine during New York City's #Coronavirus Quarantine",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "iMattSmart, 2020 -",
                                                tags$a(href = "https://unsplash.com/photos/8vTKvTdenyc",
                                                       "Coronavirus stay at home",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "KOBU Agency, 2020 -",
                                                tags$a(href = "https://unsplash.com/photos/Q0cm4L_Mvws",
                                                       "Coronavirus / Covid-19 cases in the world.",
                                                       class = "externallink")),
                                        tags$li(class = "li-custom", "SJ Obijo, 2020 -",
                                                tags$a(href = "https://unsplash.com/photos/8hHxO3iYuU0",
                                                       "Covid-19 Face Masks",
                                                       class = "externallink"))
